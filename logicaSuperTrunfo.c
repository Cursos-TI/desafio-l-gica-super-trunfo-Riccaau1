...
int main() {
    ...
    int pontos_tur1 = 10, pontos_tur2 = 20;
    ...
    */
    ...
    scanf("%d", &escolhajogador2);
        ...
        if (escolhajogador1 == escolhajogador2)
        {
            ...
            soma1 = (escolhajogador1 = ( + ));
            soma2 = (escolhajogador2 = (comparacao1 + comparacao2));
            vencedor = (soma1 > soma2) ? soma1 : soma2;
